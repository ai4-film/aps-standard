...
> **APS 1.0.2** — wersja uzupełniająca dokument o warstwę atrybucji i zarządzania
> standardem. Wykaz zmian: [CHANGELOG.md](https://github.com/ai4-film/aps-standard/blob/main/CHANGELOG.md) · sprostowania do 1.0:
> [ERRATA-1.0.md](https://github.com/ai4-film/aps-standard/blob/main/ERRATA-1.0.md)
> Wymagania normatywne nie uległy zmianie względem wersji 1.0 i 1.0.1. Deklaracja
> zgodności z wersją wcześniejszą pozostaje ważna i nie wymaga żadnego działania.

| | |
|---|---|
| **Wersja** | 1.0.2 — wrzesień 2026 |
...
| **Język** | Polski (wersja anglojęzyczna: [APS 1.0.2-EN](https://github.com/ai4-film/aps-standard/blob/main/docs/APS_v1.0.2_EN.md)) |
...
| Wersja | Data | Zmiany |
|---|---|---|
| **1.0.2** | Wrzesień 2026 | Dodanie warstwy atrybucji i zarządzania standardem: model zarządzania, zasady używania nazwy, otwarty rejestr wdrożeń, metadane cytowania, rejestr metodologiczny. Tekst wymagań normatywnych bez zmian względem 1.0.1. |
...
**Zarządzanie standardem, nazwa i cytowanie**

O zmianach w standardzie decyduje tryb opisany w [GOVERNANCE.md](https://github.com/ai4-film/aps-standard/blob/main/GOVERNANCE.md);
zasady wersjonowania i formę deklaracji zgodności określa [VERSIONING.md](https://github.com/ai4-film/aps-standard/blob/main/VERSIONING.md).
Propozycje merytoryczne zgłasza się publicznie, z okresem konsultacji nie krótszym niż
30 dni — [CONTRIBUTING.md](https://github.com/ai4-film/aps-standard/blob/main/CONTRIBUTING.md). Zmiana wprowadzona poza tym trybem
nie jest wersją standardu.

Licencja Apache 2.0 nie udziela praw do znaków towarowych. Warunki używania nazw „APS”
i „AI Production Standard”, w tym oznaczania wdrożeń jako zgodnych ze standardem, określa
[TRADEMARK.md](https://github.com/ai4-film/aps-standard/blob/main/TRADEMARK.md). Otwarty rejestr wdrożeń wraz z trybem zgłoszenia
prowadzony jest w [IMPLEMENTATIONS.md](https://github.com/ai4-film/aps-standard/blob/main/IMPLEMENTATIONS.md); wpis jest bezpłatny,
niewyłączny i nie stanowi certyfikacji ani rekomendacji dostawcy.

Zalecana forma cytowania:

> AI4.FILM, *AI Production Standard (APS) 1.0.2 (2026)*, DOI: 10.5281/zenodo.22690397, § 2.3

Wskazany DOI obejmuje wszystkie wersje standardu i prowadzi do najnowszej. Cytowanie
wiążące w dokumentacji dostawczej wskazuje DOI konkretnej wersji, podany w jej rekordzie
w Zenodo. Metadane cytowania w formacie maszynowym: [CITATION.cff](https://github.com/ai4-film/aps-standard/blob/main/CITATION.cff).
...
Rejestr metodologiczny niezależny od wersji, wskazujący kolofon każdej opublikowanej
wersji jako źródło rozstrzygające, prowadzony jest w [METHODOLOGY.md](https://github.com/ai4-film/aps-standard/blob/main/METHODOLOGY.md).
...
*APS v1.0.2 • AI4.FILM • wrzesień 2026 • Apache 2.0 • hello@ai4.film*
