# AI Production Standard (APS) 1.0.2

**A standard for documenting and managing intellectual property rights when using AI tools in film production**

> **APS 1.0.2** — adding the attribution and governance layer to the document.
> See [CHANGELOG.md](https://github.com/ai4-film/aps-standard/blob/main/CHANGELOG.md) · corrections to 1.0:
> [ERRATA-1.0.md](https://github.com/ai4-film/aps-standard/blob/main/ERRATA-1.0.md)
> Normative requirements are unchanged from versions 1.0 and 1.0.1. A declaration of
> conformity with an earlier version remains valid and requires no action.
...
| **Language** | English (Polish version: [APS 1.0.2-PL](https://github.com/ai4-film/aps-standard/blob/main/docs/APS_v1.0.2_PL.md)) |
...
|---|---|---|
| **1.0.2** | September 2026 | Addition of the attribution and governance layer: governance model, rules for use of the name, open implementation register, citation metadata, methodological register. The text of the normative requirements is unchanged from 1.0.1. |
...
**Governance, name and citation**

Changes to the standard are decided under the procedure set out in
[GOVERNANCE.md](https://github.com/ai4-film/aps-standard/blob/main/GOVERNANCE.md); versioning rules and the form of a declaration of
conformity are set out in [VERSIONING.md](https://github.com/ai4-film/aps-standard/blob/main/VERSIONING.md). Substantive proposals are
submitted publicly, with a consultation period of no less than 30 days —
[CONTRIBUTING.md](https://github.com/ai4-film/aps-standard/blob/main/CONTRIBUTING.md). A change introduced outside that procedure is
not a version of the standard.

The Apache 2.0 license grants no trademark rights. The conditions for using the names
“APS” and “AI Production Standard”, including designating an implementation as conforming
to the standard, are set out in [TRADEMARK.md](https://github.com/ai4-film/aps-standard/blob/main/TRADEMARK.md). An open register of
implementations, with the submission procedure, is maintained in
[IMPLEMENTATIONS.md](https://github.com/ai4-film/aps-standard/blob/main/IMPLEMENTATIONS.md); listing is free of charge, non-exclusive,
and is neither a certification nor a vendor recommendation.

Recommended citation:

> AI4.FILM, *AI Production Standard (APS) 1.0.2 (2026)*, DOI: 10.5281/zenodo.22690397, § 2.3

That DOI covers all versions of the standard and resolves to the most recent one. A
binding citation in delivery documentation states the DOI of the specific version, given
in that version's Zenodo record. Machine-readable citation metadata:
[CITATION.cff](https://github.com/ai4-film/aps-standard/blob/main/CITATION.cff).
...
A version-independent methodological register, pointing to the disclosure colophon of
each published version as the authoritative source, is maintained in
[METHODOLOGY.md](https://github.com/ai4-film/aps-standard/blob/main/METHODOLOGY.md).
...
*APS v1.0.2 • AI4.FILM • September 2026 • Apache 2.0 • hello@ai4.film*
